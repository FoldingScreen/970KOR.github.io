  ...
  state.unsubscribeParties=partiesRef(state.currentEventId).onSnapshot(snap=>{
    state.parties=snap.docs.map(doc=>{
      ...
      return{
        ...
        rallyPoints:Array.isArray(d.rallyPoints)?d.rallyPoints:[],
        rallyResults:Array.isArray(d.rallyResults)?d.rallyResults:[],
        gatherMinutes:Number(d.gatherMinutes||1),
        manualMode:!!d.manualMode,
        arrivalTime:d.arrivalTime||"",
        calculatorUpdatedBy:d.calculatorUpdatedBy||"",
