...
const WEAPONS = [
  { id: "magic_staff", name: "마력탄 지팡이", desc: "가장 가까운 적들에게 마력탄을 자동 발사합니다.", color: "#93c5fd", tags: ["magic", "projectile"] },
  { id: "flame_heart", name: "화염 심장", desc: "주변에 화염 오라를 유지해 지속 피해를 줍니다.", color: "#fb7185", tags: ["fire", "aura", "area"] },
  { id: "orbit_axe", name: "회전 도끼", desc: "주변을 도는 도끼가 적에게 접촉 피해를 줍니다.", color: "#fbbf24", tags: ["orbit", "physical"] }
];
